...
--- не работает как надо, считает не только интревал не только между "соседними" фильмами
...
-- среднего числа зрителей за сеанс и общей суммы сборов по каждому фильму (отсортировать по убыванию прибыли).Внизу таблицы должна быть строчка « итого »,
-- содержащая данные по всем фильмам сразу;


-- Строка ИТОГО размещена в начале таблицы, в конец не получилось
...
-- сгруппированные по времени начала фильма: с 9 до 15,
-- с 15 до 18,
-- с 18 до 21,
